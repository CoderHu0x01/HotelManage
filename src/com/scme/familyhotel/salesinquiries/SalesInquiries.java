...
public class SalesInquiries extends JFrame {
	...
	private String[] coumData = { "账单号", "房间号", "宾客姓名", "已收押金", "实收押金", "结算时间", "备注" };
	private String[] coumtaba = { "会员编号", "房间号", "宾客姓名", "性别", "证件类型", "证件编号", "人数", "押金", "预住天数", "当前状态", "入住时间",
			"结账时间", "结算单号" };
	private String[] coumfour = { "房间号", "房间类型", "单价", "折扣比例", "折后单价", "优惠金额", "入住时间" };
	...
	public SalesInquiries() {
		...
		}
		{
...

			{
				...
				tabbedPane.addTab("结账单查询", new ImageIcon("pic/u04.gif"), panel, null);
			...
			}
			{
				...
				tabbedPane.addTab("全部宾客信息查询", new ImageIcon("pic/u02.gif"), panel_1, null);
				panel_1.setLayout(null);
				{
					JLabel label = new JLabel("宾客姓名/证件编号/房间号");
			...
			}
			{
				...
				tabbedPane.addTab("在店宾客消费查询", new ImageIcon("pic/u03.gif"), panel_2, null);
			...
			}
			{
				...
				}
				{
					...
					comboBox.setModel(new DefaultComboBoxModel(new String[] { "按结账单号", "按房间编号" }));
